        ...
        <div id="ui" class="ui">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="dropdown dropdown-usermenu">
                            <a href="#" class=" dropdown-toggle" data-toggle="dropdown" aria-expanded="true">
                                ...
                                <span class="hidden-sm hidden-xs"><?php echo $_SESSION['g_name']; ?></span>
            ...
            <aside id="aside" class="ui-aside">
                <ul class="nav" ui-nav>
                    ...
                    <li>
                        <a href="all_work_requests.php"><i class="fa fa-list-alt"></i><span> All Work Requests </span></a>
                        <ul class="nav nav-sub">
                            <li class="nav-sub-header"><a href="all_work_requests.php"><span>All Work Requests</span></a></li>
                        </ul>
                    </li>
                </ul>
            </aside>
