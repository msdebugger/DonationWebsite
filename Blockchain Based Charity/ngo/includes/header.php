...
<html>
    <head>
        ...
        <title>Blockchain in Charity | NGO</title>
        ...
        <div id="ui" class="ui">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="dropdown dropdown-usermenu">
                            <a href="#" class=" dropdown-toggle" data-toggle="dropdown" aria-expanded="true">
                                ...
                                <span class="hidden-sm hidden-xs"><?php echo $_SESSION['n_name']; ?></span>
            ...
            <aside id="aside" class="ui-aside">
                <ul class="nav" ui-nav>
                    ...
                    <li>
                        <a href=""><i class="fa fa-group"></i><span>Work Requirement</span><i class="fa fa-angle-right pull-right"></i></a>
                        <ul class="nav nav-sub">
                            <li class="nav-sub-header"><a href=""><span>Work Requirement</span></a></li>
                            <li><a href="index.php"><span>All Work Requirement</span></a></li>
                            <li><a href="add_work_requirement.php"><span>Add Work Requirement</span></a></li>
                        </ul>
                    </li>
                    <!-- <li>
                    ...
                    <li>
                        <a href="all_tenders.php"><i class="fa fa-list-alt"></i><span> All Tenders </span></a>
                        <ul class="nav nav-sub">
                            <li class="nav-sub-header"><a href="all_tenders.php"><span>All Tenders</span></a></li>
                        </ul>
                    </li> -->
                    <!-- <li>
