                                ...
                                <section class="panel">
                                    ...
                                    <div class="panel-body table-responsive">
                                        <table class="table convert-data-table table-striped">
                                            ...
                                            <tbody>
                                            <?php
                                                $sql = "SELECT ngo.n_name, work_req.w_title, tender.t_price, tender.t_status, tender.t_time FROM `tender` LEFT JOIN contractor ON contractor.c_id = tender.c_id LEFT JOIN work_req ON work_req.w_id = tender.w_id LEFT JOIN ngo ON ngo.n_id = work_req.n_id WHERE tender.c_id = ".$_SESSION['c_id'];
