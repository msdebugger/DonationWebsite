...
<html>
    <head>
        ...
        <title>Blockchain in Charity | Contractor</title>
        ...
        <div id="ui" class="ui">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="dropdown dropdown-usermenu">
                            <a href="#" class=" dropdown-toggle" data-toggle="dropdown" aria-expanded="true">
                                ...
                                <span class="hidden-sm hidden-xs"><?php echo $_SESSION['c_name']; ?></span>
            ...
            <aside id="aside" class="ui-aside">
                <ul class="nav" ui-nav>
                    ...
                    <li>
                        <a href="index.php"><i class="fa fa-list-alt"></i><span> Work Requirements </span></a>
                        <ul class="nav nav-sub">
                            <li class="nav-sub-header"><a href="index.php"><span>Work Requirements</span></a></li>
                        </ul>
                    </li>
                    <li>
                        <a href="my_bids.php"><i class="fa fa-list-alt"></i><span> My Bids </span></a>
                        <ul class="nav nav-sub">
                            <li class="nav-sub-header"><a href="my_bids.php"><span>My Bids</span></a></li>
                        </ul>
                    </li>
                    <!-- <li>
